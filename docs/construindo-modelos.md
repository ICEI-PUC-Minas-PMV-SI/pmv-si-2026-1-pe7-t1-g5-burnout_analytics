...
### 3.2 Avaliação do Random Forest
...
## 3.4 Comparação entre os três modelos
...
### 3.5.1 Análise crítica do desempenho perfeito
...
### 3.5.4 Relação com a questão de pesquisa
